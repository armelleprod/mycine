...
function LobbyDecor() {
  return (
    <>
      ...
      <div className="seat-row seat-row-one"/>
      <div className="seat-row seat-row-two"/>
      <div className="cinema-prop prop-camera">🎥</div>
      <div className="cinema-prop prop-popcorn">🍿</div>
      <div className="cinema-prop prop-clap">🎬</div>
    </>
  );
}
...
function TopNav({page, setPage, savedCount}) {
  const items = [
    ...
    {id:"saved", label:`Saved Films ❤️${savedCount ? ` ${savedCount}` : ""}`},
...
function CinemaMomentCard({moment, compact=false}) {
  return (
    <article className={compact ? "moment-card compact" : "moment-card"}>
      ...
      <div className="moment-ribbon">✨ Celebrating the people behind the Seventh Art</div>
    </article>
  );
}
    ...
    <main className="page-shell">
      <div className="curator-card">
        ...
        <div>
          ...
          <p className="curator-lead">Screenwriter, lifelong film lover and creator of My Ciné.</p>
          <p>I believe cinema is one of humanity’s greatest art forms. After spending too many evenings scrolling through thousands of titles only to settle for something mediocre, I built the app I wished already existed.</p>
          <p>My Ciné is my personal love letter to the Seventh Art. I am offering it free because discovering a great film should be simple, joyful and shared.</p>
          <p>I hope it helps you spend less time searching and more time falling in love with cinema.</p>
          <div className="curator-signature">Enjoy the show! 🍿</div>
        </div>
      </div>
    </main>
  );
  ...
  return (
    <main className="page-shell">
      <div className="page-heading">
        <span>❤️</span>
        <h1>Saved Films</h1>
        <p>Your personal shelf of titles worth remembering.</p>
      </div>
...
const run = async (excludeIds = []) => {
  ...
  *{box-sizing:border-box;}
  ...
  @media (max-width:760px){
    ...
    .curator-card{grid-template-columns:1fr;text-align:center;}
