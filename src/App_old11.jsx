      ...
      <div className="curator-card cinematic-biography">
        <div className="curator-identity">
          ...
          <div className="legacy-card">
            <div className="legacy-kicker">A legacy in cinema</div>
            <div className="legacy-title">Maurice Cloche</div>
            <div className="legacy-copy">
              My grandfather directed <em>Monsieur Vincent</em>, honored with an Academy Award.
            </div>
          </div>
        </div>
        ...
        <div className="curator-story">
          ...
          <p className="curator-lead">
            I arrived in Hollywood at 20 with nothing but a suitcase, a strong French accent and the certainty that stories could change the world.
          </p>

          <p>
            Fast-forward sixteen screenplays later, and I now write, watch and celebrate cinema from Guadalajara, Mexico. Along the way, I learned that loving movies is not only about what appears on screen. It is also about the writers, directors, editors, composers, cinematographers, costume designers and countless artists whose names deserve to be remembered.
          </p>

          <p>
            Cinema was already part of my family story. My grandfather, French director <strong>Maurice Cloche</strong>, directed <em>Monsieur Vincent</em>, a film honored with an Academy Award. But My Ciné is also deeply personal to me: it grew from the very modern frustration of spending 45 minutes scrolling through endless choices only to settle for something mediocre.
          </p>

          <p>
            So I built the app I wished already existed. <strong>My Ciné</strong> is my love letter to the Seventh Art: seven thoughtful recommendations at a time, available where you live, designed to help you spend less time searching and more time discovering unforgettable stories.
          </p>
          ...
          <div className="curator-credentials">
            ...
            <div><span>🎥</span><strong>A family legacy</strong><small>Granddaughter of director Maurice Cloche</small></div>
