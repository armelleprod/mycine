  ...
  const submitNewsletter = event => {
    ...
    window.setTimeout(() => {
      try {
        ...
        // The subscription still reaches Zoho even if browser storage is blocked.
      }
      ...
      <div className="newsletter-card">
        {status === "success" ? (
          <div className="newsletter-success">
            ...
            <p>
              If you do not see the confirmation email, check Spam or Promotions.
            </p>
          ...
          <>
            ...
            <iframe
              title="Zoho newsletter submission"
              name="_mycineZohoSignup"
              className="newsletter-hidden-frame"
            />

            <form
              ref={formRef}
              method="POST"
              action="https://lblgp-zgpm.maillist-manage.com/weboptin.zc"
              target="_mycineZohoSignup"
            ...
            >
              ...
              <input type="hidden" name="lD" value="11037308a907ad451"/>
              <input type="hidden" name="emailReportId" value=""/>
              <input type="hidden" name="zx" value="1270da16f"/>
              <input type="hidden" name="zcvers" value="3.0"/>
              <input type="hidden" name="oldListIds" value=""/>
              <input type="hidden" name="mode" value="OptinCreateView"/>
              <input type="hidden" name="zcld" value="11037308a907ad451"/>
              <input type="hidden" name="zctd" value="11037308a8fad33c1"/>
              <input type="hidden" id="document_domain" name="document_domain" value=""/>
              <input type="hidden" id="zc_Url" name="zc_Url" value="lblgp-zgpm.maillist-manage.com"/>
              ...
              <input type="hidden" name="zc_formIx" value="3z7ff46eb2aa0f60d7735493e08e972db821435fc6e9bd9755996562f14b6a6f2e"/>
