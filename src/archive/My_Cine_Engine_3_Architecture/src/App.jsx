...
import {ENGINE_VERSION} from "./engine3";
    ...
    <main className="page-shell">
      ...
      <div className="standard-grid">
        ...
        <section className="standard-card">
          ...
          <p>Every recommendation must reach at least 75% in the live TMDB community rating. The My Ciné Canon provides editorial judgment, while Engine 3.0 separates candidate building, quality, freshness, diversity, role casting and final editorial review into independent stages.</p>
