...
// ── MY CINÉ ENGINE 2.0 ───────────────────────────────────────────────────────
const RECOMMENDATION_HISTORY_KEY = "mycine-recommendation-history-romcom-db-v2";
      ...
      <div className="app-content">
        {error&&(
          <div className="public-error">
            <strong>🎬 My Ciné is preparing seven completely different choices.</strong>
            <span>Your current seven remain visible until the new set is ready.</span>
          </div>
        )}
        {loading&&<Skeleton/>}
