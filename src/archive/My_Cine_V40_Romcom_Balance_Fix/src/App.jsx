...
// ── MY CINÉ ENGINE 2.0 ───────────────────────────────────────────────────────
const RECOMMENDATION_HISTORY_KEY = "mycine-recommendation-history-romcom-db-v4";
...
const run = async (
  ...
  try {
    ...
    const activeSelectionKey = recommendationSelectionKey(
      tab,
      selGenres,
      selMood,
      contentMode
    ...
    if (
      ...
      advanceRomcomRotation(activeSelectionKey);
    }
  ...
  const doFetch = () => {
    ...
    // Start Fresh means a different batch within the same rotation.
  ...
  const startNewRecommendationSession = () => {
    ...
    if (tab === "genre" && selGenres.includes("romcom")) {
      resetRomcomRotation(key);
    }
      ...
      <div className="app-content">
        {error&&(
          <div className="public-error">
            <strong>🎬 My Ciné could not complete the next balanced set.</strong>
