    ...
    <main className="page-shell">
      ...
      <div className="standard-grid">
        ...
        <section className="standard-card">
          ...
          <p>Every recommendation must reach at least 75% in the live TMDB community rating. The Romcom Canon contains 100 editorially approved titles. Current-session repeats are forbidden, while older history can be relaxed silently only when needed to preserve seven strong recommendations.</p>
