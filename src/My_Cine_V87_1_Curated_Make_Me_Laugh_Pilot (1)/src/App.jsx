...
import { LAUGH_MOVIE_EDITORIAL_BATCHES, LAUGH_SERIES_EDITORIAL_BATCHES } from "./data/moodBatches";
...
export default function App() {
  ...
  const activePreparedBatches =
    tab === "mood" && selMood === "laugh"
      ? contentMode === "movie"
        ? LAUGH_MOVIE_EDITORIAL_BATCHES
        : contentMode === "tv"
          ? LAUGH_SERIES_EDITORIAL_BATCHES
...
const run = async (
  ...
  try {
    const preparedGenre =
      tab === "mood" && selMood === "laugh" && Boolean(activePreparedBatches)
        ? "mood-laugh"
        : tab === "genre" &&
            selGenres.length === 1 &&
